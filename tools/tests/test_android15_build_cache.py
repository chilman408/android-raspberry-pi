...
VALID_WORKFLOW = """
env:
  ANDROID_BUILD_BASELINE: android-platform-15.0.0_r3-tesla-2026.22.1-runtime-v4
...
class WorkflowContractTests(unittest.TestCase):
    ...
    def test_required_workflow_fragments_are_enforced(self):
        mutations = (
            ("android-platform-15.0.0_r3-tesla-2026.22.1-runtime-v4", "wrong"),
    ...
    def test_declared_baseline_must_match_exactly(self):
        mutated = VALID_WORKFLOW.replace(
            "android-platform-15.0.0_r3-tesla-2026.22.1-runtime-v4",
            "android-platform-15.0.0_r3-tesla-2026.22.1-runtime-v4-wrong",
        )
        result = self.run_checker(mutated, VALID_HELPER)
        self.assertNotEqual(result.returncode, 0)
